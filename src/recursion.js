...
var sum = function(array) {
  if (array.length < 1) {
    ...
    var currNum = array[0];
    return currNum + sum(array.slice(1));
  }
};
...
var arraySum = function(array) {
  if (array.length < 1) {
    ...
    if (typeof currElement === 'number') {
      return currElement + arraySum(array.slice(1));
    } else {
      return arraySum(currElement) + arraySum(array.slice(1));
    }
  }
};
...
var range = function(x, y) {
  ...
  if (Math.abs(y - x) === 2) {
    ...
    return [ x + direction ].concat(range (x + direction, y))
  }
};
